...
import forgotpasswordTicket from "../assets/mobile-password-forgot (1).png"
...
const ForgotPassword = () => {
    ...
    return (
        /* Veso prensipal la transparan pou pwofite background body a, ak tranzisyon dous */
                ...
                {status === 'success' ? (
                    <div className="text-center flex flex-col items-center">
                        ...
                        <p className="text-gray-500 dark:text-zinc-400 mb-8 font-medium">
                            Nou voye yon lyen pou réinitialiser modpas ou nan <span className="text-gray-900 dark:text-zinc-200 font-bold">{email}</span>
                        </p>
                        <Link to="/auth" className="text-amber-400 dark:text-amber-400 font-bold hover:underline transition-all">
                            Retounen nan koneksyon
                        </Link>
                    </div>
                ) : (
                    <>
                        {/* Imaj la ak yon ti efè refleksyon nan dark mode */}
