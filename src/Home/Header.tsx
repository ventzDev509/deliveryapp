...
export default function Header() {
    ...
    return (
        <>
            ...
            <nav className="md:hidden fixed bottom-nav bottom-0 left-0 right-0 bg-[#09090b] backdrop-blur-lg border-t border-white/[0.06] px-6 py-2.5 z-50 flex justify-between items-center shadow-2xl">
