        ...
        >
            ...
            <div className="p-4 bg-gray-50 dark:bg-zinc-950/40 border border-gray-200 dark:border-zinc-800 rounded-2xl space-y-3">
                <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-black text-orange-600 dark:text-amber-400 bg-orange-50 dark:bg-orange-950/30 px-2.5 py-0.5 rounded-lg">dk</span>
                </div>
                <input
                    type="range"
                    min="1"
                    ...
                    className="w-full h-1.5 bg-gray-200 dark:bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-amber-500"
                />
            ...
            <div className="flex flex-col gap-1.5 max-w-xs">
                ...
                <div className="relative">
                    ...
                    <input
                        type="number"
                        step="0.01"
                        className="w-full pl-8 pr-4 py-3 bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-xl text-xs font-bold text-gray-800 dark:text-zinc-200 focus:outline-none focus:bg-white dark:focus:bg-zinc-950 focus:border-amber-500 dark:focus:border-amber-500 transition-all"
                    />
                </div>
            </div>
        </motion.div>
