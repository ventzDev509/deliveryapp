...
import { Search, Plus, Edit2, ToggleLeft, ToggleRight, Flame, Utensils, Layers, Clock } from 'lucide-react';
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none border-b border-gray-100 dark:border-zinc-800/60">
        {[
          ...
          return (
            ...
            >
              <Icon size={14} className={isSelected ? "text-orange-500" : "text-gray-400 dark:text-zinc-500"} />
              {cat.label}
            </button>
          );
        })}
        ...
        <AnimatePresence mode="popLayout">
          {filteredDishes.map((dish) => (
            <motion.div
              ...
              className={`bg-white rounded-2xl border flex flex-col justify-between overflow-hidden transition-colors duration-200 ${
                dish.isAvailable 
              ...
              <div className="p-4 flex gap-4">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="text-xs font-black text-orange-600 bg-orange-50 dark:bg-orange-950/40 dark:text-orange-400 px-2 py-0.5 rounded-lg">${dish.price.toFixed(2)}</span>
                  </div>
