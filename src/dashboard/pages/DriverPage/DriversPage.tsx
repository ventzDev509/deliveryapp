        ...
        <>
          ...
          >
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between">
              ...
              <button type="button" onClick={onClose} className="p-2 bg-gray-50 hover:bg-gray-100 rounded-full text-gray-500 transition-colors">
                <X size={16} />
              </button>
            </div>
              ...
              <div className="flex items-center gap-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                ...
                <div className="flex-1 space-y-1.5">
                  ...
                  <select 
                    ...
                    className="w-full px-3 py-2 bg-white border border-gray-200 rounded-xl text-xs font-bold text-gray-800 focus:outline-none focus:border-orange-500 transition-all"
                  >
...
const DriversPage = () => {
  ...
  const handleAddNewDriver = () => {
    setSelectedDriver({
      ...
      phone: '',
      email: '',
      avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=200", // avatar default
      status: 'Available',
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      default:
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-gray-50 text-gray-500 text-[10px] font-bold rounded-full border border-gray-200">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-black text-gray-900 tracking-tight">Jesyon Chofè yo</h1>
          <p className="text-xs text-gray-400">Swiv, modifye, epi kontwole flòt chofè Delivery Delivery yo.</p>
        </div>
        <button 
      ...
      <div className="flex flex-col md:flex-row gap-3 items-center justify-between bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
        <div className="relative w-full md:w-80">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium text-gray-700 focus:outline-none focus:bg-white focus:border-orange-500 transition-all"
          />
        </div>

        <div className="flex items-center gap-2 w-full md:w-auto overflow-x-auto scrollbar-none py-1">
          <SlidersHorizontal size={14} className="text-gray-400 hidden sm:block flex-shrink-0" />
        ...
        <AnimatePresence mode="popLayout">
          {filteredDrivers.map((driver) => (
            <motion.div
              ...
              key={driver.id}
              className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between relative overflow-hidden"
            >
              <div className="flex items-center justify-between mb-4">
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-wider">{driver.id}</span>
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="space-y-1 min-w-0">
                  <h3 className="text-sm font-black text-gray-900 truncate">{driver.name}</h3>
              ...
              <div className="bg-gray-50 rounded-xl p-3 space-y-2 mb-4 border border-gray-100">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-gray-400 font-medium flex items-center gap-1.5">
                    {getVehicleIcon(driver.vehicle.type)} {driver.vehicle.model}
                  </span>
                  <span className="bg-white px-2 py-0.5 border border-gray-200 rounded text-gray-700 font-black tracking-wide uppercase text-[9px]">
                ...
                {driver.status === 'Busy' && driver.currentOrderId && (
                  <div className="pt-2 border-t border-gray-200/60 flex items-center justify-between text-[10px]">
                    ...
                    <span className="text-gray-400 italic">Nan wout...</span>
                  </div>
                )}
              </div>
              ...
              <div className="pt-3 border-t border-gray-100 flex items-center justify-between gap-2">
                <div className="flex items-center gap-1.5">
                  <a href={`tel:${driver.phone}`} className="p-2 bg-gray-50 hover:bg-orange-50 hover:text-orange-500 text-gray-500 rounded-lg transition-colors">
                    <Phone size={13} />
                  </a>
                  <a href={`mailto:${driver.email}`} className="p-2 bg-gray-50 hover:bg-orange-50 hover:text-orange-500 text-gray-500 rounded-lg transition-colors">
                    <Mail size={13} />
                  </a>
                </div>
                ...
                <button 
                  ...
                  className="px-3 py-1.5 hover:bg-gray-50 border border-gray-200 text-gray-600 text-[11px] font-bold rounded-lg transition-all active:scale-95"
                >
                  Gade Profile
                </button>
              </div>
      ...
      {filteredDrivers.length === 0 && (
        <div className="text-center py-12 bg-white rounded-2xl border border-dashed border-gray-200">
          <p className="text-xs font-bold text-gray-400">Okenn chofè pa matche ak rechèch ou a.</p>
        </div>
      )}
